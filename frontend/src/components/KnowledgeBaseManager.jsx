            ...
            <div style={{ display: 'flex', gap: 'var(--space-lg)' }}>
                ...
                <div style={{ width: 280, flexShrink: 0 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--space-md)' }}>
                        <h3 style={{ fontSize: 'var(--font-base)', fontWeight: 700 }}>Knowledge Bases</h3>
                        ...
                        kbs.map(kb => (
                            <div
                                ...
                                style={{
                                    ...
                                    background: selectedKb?.id === kb.id ? 'var(--bg-card-hover)' : 'transparent',
                                    border: `1px solid ${selectedKb?.id === kb.id ? 'var(--border-hover)' : 'transparent'}`,
